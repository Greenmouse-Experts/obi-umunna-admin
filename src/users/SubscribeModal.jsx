...
const SubscribeModal = () => {
  ...
  const isSuccess = () => {
    localStorage.setItem("bripan_sub", "1")
  ...
  return (
    <div className="fixed flex justify-center items-center h-screen w-full top-0 left-0 bg-[#00000066]">
      <div className="w-11/12 lg:w-5/12 bg-white">
        <div className="p-5">
          <p className="font-bold text-2xl text-center">Welcome to Bripan</p>
          <p className="mt-8 text-center px-3">
            Hello {fname}, we are glad to have you on Bripan, Please subscribe
            to gain access to all services available on Bripan.
          </p>
